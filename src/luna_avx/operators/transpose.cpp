...
/*
 * Transpose Notes:
 * 8x8 transpose example on paper with operations.
 * We start to by unpacking the lo and hi values from r0 & r1, r2 & r3, etc.
 *
 *                      Unpack hi-lo
 *
 * [ 0  1  2  3  4  5  6  7]    [ 0  8  1  9  4  12 5  13 ]
 * [ 8  9 10 11 12 13 14 15]    [ 2  10 3  11 6  14 7  15 ]
 * [16 17 18 19 20 21 22 23]    [ 16 24 17 25 20 28 21 29 ]
 * [24 25 26 27 28 29 30 31]    [ 18 26 19 27 22 30 23 31 ]
 * [32 33 34 35 36 37 38 39] -> [ 32 40 33 41 36 44 32 45 ]
 * [40 41 42 43 44 45 46 47]    [ 34 42 35 43 38 46 39 47 ]
 * [48 49 50 51 52 53 54 55]    [ 48 56 49 57 52 60 53 61 ]
 * [56 57 58 59 60 61 62 63]    [ 50 58 51 59 54 62 55 63 ]
 *
 * shuffle r0_lo and r2_lo shuffle(01001110)
 *
 * [ 0  8  1  9  4  12 5  13 ]
 * [ 2  10 3  11 6  14 7  15 ]
 * [ 16 24 17 25 20 28 21 29 ]
 * [ 18 26 19 27 22 30 23 31 ]
 * [ 32 40 33 41 36 44 32 45 ] ->
